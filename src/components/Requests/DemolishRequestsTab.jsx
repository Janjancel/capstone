...
export default function DemolishRequestsTab({
  demoRequests,
  navigate,
  setSelectedDemo,
  setOpenDemoModal,
  ...
  if (demoRequests.length === 0) return null;
          ...
          <Grid key={idKey} item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                {hasProposal && waiting && (
                  <Typography sx={{ mt: 1 }}>
                    Proposed Price: ₱{Number(r.proposedPrice).toLocaleString()}
                  </Typography>
                )}
